...
private:
	...
	std::mutex obiektyAktywneMap_mutex;
	std::unordered_map <int, ObiektKolizyjny*> obiektyAktywne;
	std::mutex obiektyStatyczneMap_mutex;
	std::unordered_map <int, ObiektKolizyjny*> obiektyStatyczne;
};